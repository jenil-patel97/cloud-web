...
const Pricing = () => {
  return (
    ...
    <div className='max-w-[1240px] mx-auto py-12 cursor-default'>
      <div className='text-center py-8'>
        <h2 className='text-3xl uppercase underline'>Pricing</h2>
      ...
      <div className='grid md:grid-cols-3'>
        ...
        <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
          ...
          <div className='text-2xl'>
              ...
              <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
              <button className='w-full py-4 my-4 hover:bg-blue-600 hover:text-white mt-[210px]'>Get Started</button>
          </div>
        </div>
        ...
        <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
          ...
          <div className='text-2xl'>
              ...
              <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
              <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
              <button className='w-full py-4 my-4 hover:bg-blue-600 hover:text-white mt-[145px]'>Get Started</button>
          </div>
        </div>
        ...
        <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
          ...
          <div className='text-2xl'>
              ...
              <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
              <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
              <button className='w-full py-4 my-4 hover:bg-blue-600 hover:text-white'>Get Started</button>
          </div>
        </div>
