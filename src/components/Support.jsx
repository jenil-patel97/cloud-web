...
import { CpuChipIcon, GlobeAltIcon } from "@heroicons/react/24/solid";

import supportImg from "../assests/support.jpg";

const Support = () => {
  return (
    <div name="support" className="w-full mt-24 cursor-default">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        <div className="px-4 py-12">
          <h2 className="text-3xl pt-8 uppercase text-center underline">
            Support
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold text-2xl my-6 underline">Sales</h3>
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold text-2xl my-6 underline">Technical Support</h3>
              <p className="text-black text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Excepturi provident iure placeat blanditiis ea sint earum hic
                iste quibusdam exercitationem.
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold text-2xl my-6 underline">Media Inquiries</h3>
              <p className="text-black text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Excepturi provident iure placeat blanditiis ea sint earum hic
                iste quibusdam exercitationem.
